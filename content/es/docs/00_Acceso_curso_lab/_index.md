...
8. Entonces se abrirá una ventana de **Vocareum** que es una app que gestiona los laboratorios.<br />
...
{{< alert title="Tiempo limitado" color="warning" >}}
...
{{< alert title="Buenas prácticas" color="success" >}}
